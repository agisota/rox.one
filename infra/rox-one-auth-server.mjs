...
const DATABASE_URL = process.env.ROX_AUTH_DATABASE_URL || process.env.CRAFT_DATABASE_URL || process.env.DATABASE_URL || ''
...
const WS_URL = process.env.ROX_AUTH_WS_URL || process.env.CRAFT_WEBUI_WS_URL || 'wss://rox.one/ws'
