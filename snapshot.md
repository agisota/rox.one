...
This repository is no longer a clean upstream Rox Agents OSS checkout. It is a
white-label fork that keeps the core Rox agent desktop shell and adds an
...
rox-origin https://github.com/agisota/rox.git
```
...
The app is still structurally Rox Agents:
...
These are not the same thing as Rox permission modes. They are cognitive /
