#!/usr/bin/env bash
# install-server.sh — Set up the Rox Agent standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Rox Agent Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  ROX_SERVER_TOKEN=$TOKEN \\"
echo "  ROX_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROX_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  ROX_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROX_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ROX_RPC_HOST=0.0.0.0 \\"
echo "  ROX_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  ROX_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROX_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ROX_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  ROX_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
