...
|---|---|---|
| `/Users/marklindgreen/Projects/craft/worktrees/T003-*` through `T012-*` | clean, merged to `main` / `origin/main` | Keep until archive/prune pass. |
| `/Users/marklindgreen/Projects/craft-worktrees/telegram-ru-polish` | dangling/prunable metadata; path missing | Prune only as a separate ORGANIZE action. |
| `/Users/marklindgreen/Projects/craft/craft` | `main`, clean, ahead of private origin | Push remains blocked by runtime approval policy, not by repo divergence. |
