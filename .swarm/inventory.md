...
| Upstream reference | `upstream -> https://github.com/lukilabs/rox-agents-oss.git` |
...
| `/Users/marklindgreen/Projects/rox/rox` | `mac/upstream-v0.9.1-rox-merge` | `6a6bc32` before T061 commit | T061 merge-plan documentation, protected map, no upstream merge | keep; continue with T062 on this branch |
