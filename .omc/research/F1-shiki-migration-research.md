...
`@craft-agent/ui` (`ShikiCodeViewer`, `CodeBlock`, `ShikiDiffViewer`). Vite already tree-splits
...
electron renderer and webui share the same `@craft-agent/ui` components, all three apps carry a
