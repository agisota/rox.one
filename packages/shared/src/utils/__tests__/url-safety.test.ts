...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies roxagents:// as internal-deeplink', () => {
    expect(classifyExternalUrl('roxagents://settings').kind).toBe('internal-deeplink')
  })
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('roxagents://settings')).toBe(false)
  })
