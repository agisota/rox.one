...
import { loadSkill, loadActiveSkills, invalidateSkillsCache, skillNeedsIconDownload, downloadSkillIcon } from '../skills/storage.ts';
import {
  loadStatusConfig,
...
export class ConfigWatcher {
  ...
  private handleSkillsDirChange(): void {
    ...
    try {
      ...
      const allSkills = loadActiveSkills(this.workspaceDir);
