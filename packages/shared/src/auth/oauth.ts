...
export interface OAuthConfig {
  mcpUrl: string; // Full MCP URL including path (e.g., https://mcp.rox.do/my/mcp)
}
...
const CLIENT_NAME = 'Claude Code (Rox Agent)';
 ...
 * Extracted from RoxOAuth.registerClient for reuse in prepareMcpOAuth.
 */
...
export async function discoverOAuthMetadata(
  ...
  // 1. Try RFC 9728 protected resource discovery first (handles Rox MCP and other compliant servers)
