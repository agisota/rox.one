 ...
 *   ROX_ANTHROPIC_API_KEY or ANTHROPIC_API_KEY - Anthropic API key
 *   ROX_CLAUDE_OAUTH_TOKEN - Claude OAuth token
 *
...
const ENV_MAP: Record<string, string[]> = {
  anthropic_api_key: ['ROX_ANTHROPIC_API_KEY', 'ANTHROPIC_API_KEY'],
  claude_oauth: ['ROX_CLAUDE_OAUTH_TOKEN'],
};
