 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.rox-agent/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.rox-agent/release-notes/
  // (Docker/remote server may not have ROX_BUNDLED_ASSETS_ROOT set,
