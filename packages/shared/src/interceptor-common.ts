...
export const CONFIG_FILE = join(homedir(), '.rox-agent', 'config.json');

// ============================================================================
// LOGGING
// ============================================================================

export const LOG_DIR = join(homedir(), '.rox-agent', 'logs');
...
const ERROR_FILE = join(homedir(), '.rox-agent', 'api-error.json');
 ...
 * - SDK subprocess: ROX_SESSION_DIR env var (set by main process before spawn)
...
let _sessionDir: string | null = process.env.ROX_SESSION_DIR || null;
