 ...
 *    - ~/Documents/GitHub/rox-agents-codex/... (macOS default)
 *    - ~/code/rox-agents-codex/... (Linux common)
 *    - ~/projects/rox-agents-codex/... (Linux common)
 *    - ~/src/rox-agents-codex/... (Linux common)
...
export function resolveCodexBinary(): { path: string; source: string } {
  ...
  const devPaths = [
    ...
    join(home, 'Documents', 'GitHub', 'rox-agents-codex', 'codex-rs', 'target', 'release', binaryName), // macOS default
    join(home, 'code', 'rox-agents-codex', 'codex-rs', 'target', 'release', binaryName), // Linux common
    join(home, 'projects', 'rox-agents-codex', 'codex-rs', 'target', 'release', binaryName), // Linux common
    join(home, 'src', 'rox-agents-codex', 'codex-rs', 'target', 'release', binaryName), // Linux common
