...
// ============================================================
// ROX AGENTS: PreToolUse Hook Types
// ============================================================
...
export interface AppServerEvents {
  ...
  // ROX AGENTS: PreToolUse hook request
  // Sent BEFORE tool execution to allow client to block/modify/allow
...
export class AppServerClient extends EventEmitter {
   ...
   *
   * This allows Rox Agent to own the OAuth flow and inject tokens into Codex.
  ...
  /**
   * ROX AGENTS: Respond to a PreToolUse hook request.
   *
