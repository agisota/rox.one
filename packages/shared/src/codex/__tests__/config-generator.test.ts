...
describe('generateCodexConfig', () => {
  ...
  describe('header comment', () => {
    it('should include generation comment', () => {
      ...
      expect(result.toml).toContain('# Generated by Rox Agent - DO NOT EDIT');
...
describe('getCredentialCachePath', () => {
  it('should return correct path', () => {
    const path = getCredentialCachePath('/home/user/.rox-agent/workspaces/ws-123', 'gmail');
    expect(path).toBe('/home/user/.rox-agent/workspaces/ws-123/sources/gmail/.credential-cache.json');
  });
});
