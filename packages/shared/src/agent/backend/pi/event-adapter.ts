...
import type { AgentEvent as RoxAgentEvent } from '@rox-agent/core/types';
import type {
...
export class PiEventAdapter extends BaseEventAdapter {
   ...
   *  generator. */
  private onFallbackEvent: ((event: RoxAgentEvent) => void) | null = null;
  ...
  setOverflowFallbackHandlers(
    onEvent: (event: RoxAgentEvent) => void,
    onComplete: () => void,
  ): void {
