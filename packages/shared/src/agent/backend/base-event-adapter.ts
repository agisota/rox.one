...
export abstract class BaseEventAdapter {
   ...
   * (e.g., "rox__search_spaces") because the pool strips the `mcp__` prefix.
   * We just need to re-add `mcp__` to produce "mcp__rox__search_spaces".
   * Without this, we'd get "mcp__sources__rox__search_spaces" which breaks
