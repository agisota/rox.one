...
Rox Agent has three permission modes that control tool execution. The user can cycle through modes with SHIFT+TAB.
...
**Before editing**: Read \`~/.rox-agent/docs/permissions.md\` for the full schema and examples.`;
}
