      ...
      const options: Options = {
        ...
        hooks: (() => {
          ...
          if (Object.keys(userHooks).length > 0) {
            debug('[RoxAgent] User SDK hooks loaded:', Object.keys(userHooks).join(', '));
          }
...
// ============================================================
// These aliases allow gradual migration from RoxAgent to ClaudeAgent.
// Once all consumers are updated, these can be removed.

/** @deprecated Use ClaudeAgent instead */
export { ClaudeAgent as RoxAgent };

/** @deprecated Use ClaudeAgentConfig instead */
export type { ClaudeAgentConfig as RoxAgentConfig };
