...
function buildSkills(): WorkbenchBundleSkill[] {
  return [
    ...
    makeSkill(
      ...
      'Code Review Agent Pack',
      'Reviews diffs with severity-ranked findings, file references, and test gaps.',
      '🔍',
      'Inspect changes for regressions, missing tests, unsafe assumptions, and maintainability risks before merge or release.',
    ),
    makeSkill(
      'debugger-agent-pack',
      'Debugger Agent Pack',
      'Turns failures into hypotheses, probes, root cause notes, and fix validation plans.',
      '🧰',
      'Map symptoms to likely causes, isolate regressions, propose minimal probes, and define the evidence needed to close a bug.',
    ),
    makeSkill(
      'release-manager-pack',
      'Release Manager Pack',
      'Coordinates release checklists, changelog notes, build gates, and rollback risks.',
      '📦',
      'Prepare release readiness summaries with version scope, platform gates, known risks, deployment steps, and rollback triggers.',
    ),
    makeSkill(
      'docs-writer-pack',
      'Docs Writer Pack',
      'Drafts concise user docs, migration notes, runbooks, and operator handoffs.',
      '📝',
      'Convert implementation details into clear user-facing or operator-facing documentation with prerequisites and verification steps.',
    ),
    makeSkill(
      'frontend-polish-pack',
      'Frontend Polish Pack',
      'Audits screens for copy, layout, empty states, accessibility, and interaction finish.',
      '✨',
      'Review UI surfaces for hierarchy, responsiveness, keyboard access, visual consistency, and unhandled loading or error states.',
    ),
    makeSkill(
      'backend-api-pack',
      'Backend API Pack',
      'Designs and reviews service contracts, persistence boundaries, and API failure modes.',
      '🧩',
      'Define request and response contracts, idempotency behavior, authorization boundaries, migrations, and observability expectations.',
    ),
    makeSkill(
      'data-analysis-pack',
      'Data Analysis Pack',
      'Structures metric investigations, data quality checks, and decision-ready summaries.',
      '📊',
      'Plan data pulls, validation rules, segmentation, anomaly checks, and concise findings with confidence levels.',
    ),
    makeSkill(
      'customer-support-pack',
      'Customer Support Pack',
      'Transforms issue reports into triage notes, reply drafts, and escalation packets.',
      '💬',
      'Classify customer reports, request missing diagnostics, draft responses, and produce engineering escalation summaries.',
    ),
    makeSkill(
      'automation-builder-pack',
      'Automation Builder Pack',
      'Designs repeatable automations with triggers, guards, actions, and audit evidence.',
      '⚙️',
      'Convert recurring workflows into automation specs with trigger conditions, safety checks, outputs, and verification logs.',
    ),
    makeSkill(
      'artifact-editor-pack',
      'Artifact Editor Pack',
      'Guides direct review and editing of generated documents, code files, and rich artifacts.',
      '📄',
      'Plan artifact inspection, edits, previews, version notes, and validation for files such as docs, sheets, slides, HTML, scripts, and markdown.',
    ),
  ];
}
