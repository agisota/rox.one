...
import type { SessionBundle, DispatchMode } from '@rox-agent/shared/sessions'
...
export interface ISessionManager {
  ...
  exportRemoteSessionTransfer(
    sessionId: string,
    workspaceId: string,
  ): Promise<import('@rox-agent/shared/protocol').RemoteSessionTransferPayload | null>
  ...
  importRemoteSessionTransfer(
    workspaceId: string,
    payload: import('@rox-agent/shared/protocol').RemoteSessionTransferPayload,
  ): Promise<import('@rox-agent/shared/protocol').ImportRemoteSessionTransferResult>
