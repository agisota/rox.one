...
import { type AuthRequest, type PermissionMode } from '@rox-agent/shared/agent'
import { type Workspace } from '@rox-agent/shared/config'
import {
  type LoadedSource,
  isSourceUsable,
...
import { getToolIconsDir } from '@rox-agent/shared/config'
