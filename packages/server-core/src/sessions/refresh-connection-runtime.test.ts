...
import { saveConfig, ensureConfigDir, type LlmConnection } from '@rox-agent/shared/config'
...
describe('refreshConnectionRuntime', () => {
  ...
  beforeEach(() => {
    previousConfigDir = process.env.ROX_CONFIG_DIR
  ...
  afterEach(() => {
    ...
    if (previousConfigDir === undefined) {
      ...
      process.env.ROX_CONFIG_DIR = previousConfigDir
    }
  })
