 ...
 * `@craft-agent/core`. The full provider-facing contract lives in
 * `@craft-agent/shared` as `AgentBackend` (see
 ...
 * import `AgentBackend` from `@craft-agent/shared/agent`. If you only need
 ...
 * `@craft-agent/shared/agent#AgentBackend`. Every member here has an
 ...
 *
 * Members are limited to those whose signatures touch only `@craft-agent/core`
