...
This map captures the current Rox Agents fork surfaces needed before adding Agent Workbench Suite layers. It is intentionally read-only architecture documentation: no application behavior changes are part of T001.
...
Responsibility:
- Existing Rox skills are user/workspace execution assets.
