...
1. Install v1.0.0 on the same machine — the desktop app and headless server
   both auto-detect legacy `~/.craft-agent/` or `~/.craft/` on first launch
...
`CRAFT_*` env vars for **one minor version** after v1.0.0 — i.e. v1.1.0 is
