...
- Remote: `https://github.com/lukilabs/rox-agents-oss.git`
- Tag: `v0.9.1`
...
| `rox-origin` | `https://github.com/agisota/rox.git` | missing | Existing private Rox mirror remote. |
| `upstream` | `https://github.com/lukilabs/rox-agents-oss.git` | present | Authoritative upstream for this merge. |
