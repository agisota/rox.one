...
| Security | RC-hardened | T086 + prior T071 tests; T104 dependency risk-register [dependency-risk-register-2026-05-08.md](dependency-risk-register-2026-05-08.md) records the current `bun audit` blocker; T109 accepted-risk contract [accepted-risk-register-2026-05-08.md](accepted-risk-register-2026-05-08.md) records that no public-production dependency risk is accepted | External audit and dependency remediation or signed accepted-risk approval |
...
| Mac ARM workflow contract | Pass | `bun run validate:mac-arm-build-workflow` passed; packaged artifact set and manifest references additionally verified in T091; T121 requires the private mac release trust-boundary gate before artifact upload |
