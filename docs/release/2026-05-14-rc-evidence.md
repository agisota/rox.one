...
| S07 | [T358](../tickets/T358-rc-s07-smoke-harness-and-command-repair.md) | S07 is not registered in `e2e:smoke`, and T345 points at a stale sync test glob; deterministic adjacent sync tests pass outside the harness. | Todo |
