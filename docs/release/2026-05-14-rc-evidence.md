...
| S06 | File upload → entity graph → source link | [T344](../tickets/T344-rc-s06-file-upload-entity-graph.md) | `Blocked` | `3070640a` | `2026-05-13T23:30:03Z` | [T357](../tickets/T357-rc-s06-smoke-harness-and-command-repair.md) tracks the unsupported S06 smoke scenario and stale file/entity graph validation paths. Current adjacent file/entity graph tests pass 30/30; packaged screenshot/browser-console evidence is still pending. |
...
| S06 | [T357](../tickets/T357-rc-s06-smoke-harness-and-command-repair.md) | S06 is not registered in `e2e:smoke`, and T344 points at stale file/entity graph test paths; deterministic adjacent tests pass outside the harness. | Todo |
