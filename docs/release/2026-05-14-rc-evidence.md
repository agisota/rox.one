...
| S08 | Share session → public shortlink opens | [T346](../tickets/T346-rc-s08-share-session-shortlink.md) | `Blocked` | `6de3ea36` | `2026-05-13T23:42:41Z` | [T359](../tickets/T359-rc-s08-smoke-harness-and-command-repair.md) tracks the unsupported S08 smoke scenario and stale shortlink/share validation globs. Current adjacent share provider/UI-state tests pass 20/20; packaged screenshot/browser-console evidence is still pending. |
...
| S08 | [T359](../tickets/T359-rc-s08-smoke-harness-and-command-repair.md) | S08 is not registered in `e2e:smoke`, and T346 points at stale shortlink/share test globs; deterministic adjacent share tests pass outside the harness. | Todo |
