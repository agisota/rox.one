...
| S09 | Upstream base still passes ROX custom flows | [T347](../tickets/T347-rc-s09-upstream-base-rox-custom-flows.md) | `Blocked` | `e10537ef` | `2026-05-14T00:17:32Z` | [T362](../tickets/T362-rc-s09-full-gate-and-smoke-harness-repair.md) registers `s09-upstream-rox-flows`; current S09 smoke passes 325 tests across 32 files. Full `bun test` still exits 1 with 181 failures and 2 errors, split to [T363](../tickets/T363-rc-s09-full-suite-shared-fixture-repair.md). `origin/main` advanced to `303b0b05` after this evidence was captured. |
...
| S09 | [T363](../tickets/T363-rc-s09-full-suite-shared-fixture-repair.md) | Full `bun test` remains red on code base `e10537ef` with 181 failures and 2 errors across shared fixtures and runtime contracts. | TODO |
