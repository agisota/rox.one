...
| S09 | Upstream base still passes ROX custom flows | [T347](../tickets/T347-rc-s09-upstream-base-rox-custom-flows.md) | `Blocked` | `23a91c7e` | `2026-05-14T00:07:42Z` | [T360](../tickets/T360-rc-s09-full-gate-and-smoke-harness-repair.md) tracks the unsupported `s09-upstream-rox-flows` smoke scenario and red full `bun test` gate. Current protected paths pass, typecheck passes, lint exits 0 with warnings, but `bun test` exits 1 with 181 failures and 2 errors. `origin/main` advanced to `e10537ef` after this evidence was captured. |
...
| S09 | [T360](../tickets/T360-rc-s09-full-gate-and-smoke-harness-repair.md) | S09 is not registered in `e2e:smoke`, and the full `bun test` gate is red on rebased code base `23a91c7e` with 181 failures and 2 errors. | TODO |
