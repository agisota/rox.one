...
| S10 | Mac ARM build opens and smoke passes | [T348](../tickets/T348-rc-s10-mac-arm-build-smoke.md) | `Pass` | `346911fd` | `2026-05-17T04:08:36Z` | CircleCI `mac-arm-build` [#561](https://circleci.com/gh/agisota/rox-one-terminal/561) passed on `main`: workflow contract, typecheck, i18n parity, Electron build, macOS ARM64 package, packaged app smoke, startup smoke, packaged-artifact metadata, private Mac trust boundary, and artifact upload all succeeded. This is automated private/ad-hoc RC smoke evidence; final public notarization/screenshot remains release-operator evidence. |
