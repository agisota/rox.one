...
| S03 | 24h mission → checkpoint → final verification | [T341](../tickets/T341-rc-s03-mission-checkpoint-verification.md) | `Blocked` | `29b276dc` | `2026-05-13T23:14:32Z` | [T354](../tickets/T354-rc-s03-smoke-harness-and-command-repair.md) tracks the unsupported S03 smoke scenario and stale Mission Control UI glob. Durable mission tests pass 125/125 and current Mission Control/Deep Missions UI tests pass 31/31; packaged restart screenshot evidence is still pending. |
...
| S03 | [T354](../tickets/T354-rc-s03-smoke-harness-and-command-repair.md) | S03 is not registered in `e2e:smoke`, and T341's Mission Control UI command points at a stale glob; deterministic mission tests pass outside the harness. | Todo |
