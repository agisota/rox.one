...
**WT:** WT-48 — AIContextPacket builder (permission-filtered)
...
- `ai_context.built` — TBD metric/alert
- `ai_context.invalidated` — TBD metric/alert
- `ai_context.expanded` — TBD metric/alert
