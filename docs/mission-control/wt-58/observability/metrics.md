...
**WT:** WT-58 — Public Card/Whiteboard sharing + redaction
...
- `public_link.created` — TBD metric/alert
- `public_link.revoked` — TBD metric/alert
- `public_link.expired` — TBD metric/alert
- `public_link.viewed` — TBD metric/alert
