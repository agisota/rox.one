...
**WT:** WT-52 — Whiteboard + Placement (canvas separate from cards)
...
- `whiteboard.created` — TBD metric/alert
- `placement.created` — TBD metric/alert
- `placement.moved` — TBD metric/alert
- `placement.deleted` — TBD metric/alert
- `arrow.created` — TBD metric/alert
