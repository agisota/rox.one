...
- **CJM scenarios required:** create-note, link-notes
- **UI surfaces affected:** NotesPage, NoteDetail
- **Entities touched (WT-46 references):** Note
- **Events emitted (WT-49 ActivityEvent):** note.created
- **AI context implications (WT-48):** notes-context
...
- **Heptabase parity:** Notes/Cards approximation
- **Risk axes:** UI, data
