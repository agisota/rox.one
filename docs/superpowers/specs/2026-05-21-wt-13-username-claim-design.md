...
- **CJM scenarios required:** claim-username
- **UI surfaces affected:** UsernameClaimDialog
- **Entities touched (WT-46 references):** UsernameReservation
- **Events emitted (WT-49 ActivityEvent):** username.claimed, username.released
