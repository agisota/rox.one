...
In Claude Code: `Agent(subagent_type="architect", prompt="Verify Phase A.1 of audit harness against spec docs/superpowers/specs/2026-05-09-audit-harness-design.md and plan docs/superpowers/plans/2026-05-09-audit-harness-a1-static-probes.md. Working tree at /home/dev/craft/rox-one-terminal on branch feat/audit-a1-static. Run the validation commands listed in Task 27 Step 1. Report criterion-by-criterion green/red.")`.
