...
- Upstream Rox Agents OSS references remain valid only when describing
...
- `git diff --check`
- `rg -n "ROX ONE|A white-label Rox Agents fork|structurally Rox Agents|Rox permission modes" plan.md snapshot.md`
- `rg -n "Rox|ROX ONE|rox-agent|@rox-agent" plan.md snapshot.md`
