...
The root package is `rox-agent` version `0.8.12`, uses Bun workspaces, and already has package scripts for tests, typechecks, Electron builds, WebUI builds, marketing builds, i18n parity, and CI validation.
