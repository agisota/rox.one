...
- `packages/audit/package.json` — `@craft-agent/audit@0.9.1`, exact-pinned deps (`js-yaml@4.1.1`, `typescript@5.9.3`), `test:coverage` and `test:coverage:check` scripts added in T064.
...
- `cbb33c8` fix(audit): scope package name to @craft-agent/audit per monorepo convention
- `084c74c` fix(audit): refresh bun.lock after package rename to @craft-agent/audit
...
|---|---|---|
| Package name `@craft-agent/audit@0.9.1` | ✅ | `packages/audit/package.json` `name` field |
