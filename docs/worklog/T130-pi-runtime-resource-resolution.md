...
- Local `.env` sets `CRAFT_PUBLIC_APP_URL=https://rox.one`; the PI dependency-risk resolver treated that as public untrusted exposure even inside the local Electron desktop host.
