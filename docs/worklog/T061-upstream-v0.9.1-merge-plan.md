...
Prepared the protected upstream merge plan for `lukilabs/rox-agents-oss`
...
git ls-remote --exit-code --tags https://github.com/lukilabs/rox-agents-oss.git refs/tags/v0.9.1
...
|---|---|---|
| Upstream remote verified | DONE | `upstream` remote points at `lukilabs/rox-agents-oss.git`. |
