...
SyntaxError: Export named 'defaultMidStreamBehavior' not found in module '@rox-agent/shared/config'
```
...
- Replaced broad `@rox-agent/shared` mocks in files RPC tests with real temporary config/workspace state via `ROX_CONFIG_DIR`.
