...
- `Expected to contain: "ROX_CONFIG_DIR"`
...
- Electron headless smoke now uses isolated `ROX_SMOKE_USER_DATA_DIR` and
  `ROX_CONFIG_DIR` temp directories so RC smoke can run while a user-facing
