...
- Covered persistence without `ROX_DEBUG` by forcing
...
| Persistent append works without `ROX_DEBUG` | Pass | Targeted writer test disables debug and still records `scope.brand.cast_breach` |
