...
- T066 added `@craft-agent/server-core/mission-scheduler` as the durable mission
  runtime seam.
...
- `packages/server-core/src/provider-gateway/__tests__/provider-gateway-export.test.ts`
  ...
  `@craft-agent/server-core/provider-gateway`.
...
Cannot find module '@craft-agent/server-core/provider-gateway'
