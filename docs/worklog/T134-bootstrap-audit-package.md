...
- `packages/audit/package.json` — `@craft-agent/audit@0.9.1`, exact-pinned deps (`js-yaml@4.1.1`, `typescript@5.9.3`), `test:coverage` and `test:coverage:check` scripts added in T138.
