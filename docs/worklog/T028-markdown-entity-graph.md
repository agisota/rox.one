...
- `@craft-agent/shared` exposes `./workbench` in `packages/shared/package.json`; individual workbench subpath exports exist for earlier modules, but T028 can start from the aggregate export.
