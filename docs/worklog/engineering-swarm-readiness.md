...
Prepare the local ROX.ONE / Craft Agents monorepo for disciplined next-step work by:
...
- Repository root: `/Users/marklindgreen/Projects/craft/craft`
...
- Operating contract from `AGENTS.md` requires:
  ...
  - preserve existing Craft/ROX behavior unless explicitly changed.
