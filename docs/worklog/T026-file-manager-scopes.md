...
```text
error: Cannot find module '../file-manager-scopes' from '/Users/marklindgreen/Projects/craft/craft/packages/server-core/src/handlers/__tests__/file-manager-scopes.test.ts'
0 pass
1 fail
1 error
```
...
- Exported the scope helper from `@craft-agent/server-core/handlers`.
