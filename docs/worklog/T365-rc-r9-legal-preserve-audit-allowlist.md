...
```text
docs/release/m3-upstream-merge-audit.md:34 [upstream-repo-tab] | Local legal-preserve attribution URL | `https://github.com/lukilabs/rox-agents-oss` (README §License; immutable until R.11) |
