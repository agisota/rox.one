...
6. Edit `plan.md` (+20 lines, -1 deletion). HISTORICAL banner at top with §-by-§ redirections. Drops the hardcoded macOS path `/Users/marklindgreen/Projects/craft/craft` in favor of a project-relative reference.
