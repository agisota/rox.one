...
```text
[sync-v2-design] missing required file: /Users/marklindgreen/Projects/rox/rox/docs/architecture/sync-v2-design.md
...
- `bun run validate:sync-v2-design`: `[sync-v2-design] validated /Users/marklindgreen/Projects/rox/rox/docs/architecture/sync-v2-design.md`
