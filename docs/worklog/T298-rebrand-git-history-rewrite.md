...
| Remote branches reviewed | Explicit pre-rewrite helper requires origin to expose only `main` and `backup/pre-rebrand-history-rewrite-2026-05-13`; origin currently has 142 non-main/non-R.11-backup branches | Pre-rewrite blocked |
...
- Origin currently has 142 non-main/non-R.11-backup branches, so the explicit
...
remote-branch-review fail    origin has 142 non-main/non-R.11-ba...
fork-review          fail    GitHub reports 1 fork(s); expected 0.
main-sync            pass    origin/main...main is 0 0.
worktree-clean       pass    git status --porcelain is empty.
rebrand-closeouts    pass    R.0-R.10 tickets are Status: DONE a...
...
| Remote branches reviewed before rewrite | Blocked | Explicit pre-rewrite gate fails on 142 non-main/non-R.11-backup origin branches |
