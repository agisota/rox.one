...
T362 proves the S09 smoke harness path on code base `e10537ef`: the command
...
| S09 smoke remains green | Pending | T362 evidence passes; not rerun in this ticket yet |
...
| Typecheck and lint pass | Pending | T362 evidence passes; not rerun in this ticket yet |
