...
- Stale `CraftAgent`, workspace, document, and vault prose is gone.
...
- Updated `apps/electron/README.md` heading and opening prose to canonical
  `ROX.ONE`.
- Rewrote stale `CraftAgent` doc references to `ClaudeAgent`, matching the
...
- Reviewed ADR 0005 and left its technical `@craft-agent/...` import path
...
- `git diff --check`
- `rg -n "Craft|ROX ONE|craft-agent|~/.craft|Dev_Craft" apps/electron/README.md docs/decision-records/audit-harness/README.md docs/decision-records/audit-harness/0005-storage-tenancy-contract.md`
- `rg -n "Craft Agents|Craft Agent|ROX ONE|CraftAgent|Craft workspaces|Craft documents|Dev_Craft_Agents" apps/electron/README.md docs/decision-records/audit-harness/README.md docs/decision-records/audit-harness/0005-storage-tenancy-contract.md`
