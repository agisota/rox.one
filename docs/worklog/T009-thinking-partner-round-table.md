...
- Added direct package export `@rox-agent/shared/workbench/thinking-partner`.
...
| Selected cards can be passed to Spec Builder | PASS | `rox:spec-builder-intent` payload includes selected IDs and labels |
