...
Create a read-only architecture map for the Craft Agents fork before implementing Agent Workbench Suite product layers. T001 changes documentation and validation only; no source behavior is changed.
