...
Rename the audit workspace package scope from `@rox-agent/audit` to
`@rox-one/audit`.
...
- Expected failure: `packages/audit/package.json` still reported
  `@rox-agent/audit` while the test expected `@rox-one/audit`.
...
- `rg -n "@rox-agent/audit|@rox-one/audit" apps packages bun.lock tsconfig*.json package.json --glob '!**/dist/**' --glob '!**/node_modules/**' --glob '!**/.omc/**' --glob '!**/.omx/**'`
