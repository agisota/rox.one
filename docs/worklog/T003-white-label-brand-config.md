...
```text
SyntaxError: Export named 'validateBrandConfig' not found in module '/Users/marklindgreen/Projects/craft/worktrees/T003-white-label-brand-config/packages/shared/src/branding.ts'.
```

Initial red phase for React icon test:

```text
error: Cannot find module 'react/jsx-dev-runtime' from '/Users/marklindgreen/Projects/craft/worktrees/T003-white-label-brand-config/apps/electron/src/renderer/components/icons/__tests__/brand-icons.test.tsx'
```
...
```text
error: Cannot find package 'react' from '/Users/marklindgreen/Projects/craft/worktrees/T003-white-label-brand-config/apps/electron/src/renderer/components/icons/CraftAgentsLogo.tsx'
```
