...
legacy `craft` names to canonical `rox` names without changing image bytes or
...
- `apps/electron/resources/craft-logos/` -> `apps/electron/resources/rox-logos/`.
- `craft_app_icon.png` -> `rox_app_icon.png`.
- `craft_app_icon_dark.png` -> `rox_app_icon_dark.png`.
- `craft_logo_black.png` -> `rox_logo_black.png`.
- `craft_logo_white.png` -> `rox_logo_white.png`.
