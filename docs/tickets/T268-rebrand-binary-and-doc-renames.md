...
Rename the packaged CLI wrapper and CLI docs from legacy `craft*` names to
...
- Rename `apps/electron/resources/tool-icons/craft-agent.png` to
  `apps/electron/resources/tool-icons/rox-agent.png`.
- Rename `apps/electron/resources/docs/craft-cli.md` to
  `apps/electron/resources/docs/rox-cli.md`.
- Rewrite the renamed CLI doc body to use `rox-agent` commands.
- Rename `apps/electron/resources/bin/craft-agent` and `.cmd` to
