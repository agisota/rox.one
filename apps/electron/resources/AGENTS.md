...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.rox-agent/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.rox-agent/docs/` | Always overwrite on launch |
| `themes/` | `~/.rox-agent/themes/` | Always overwrite on launch |
| `permissions/` | `~/.rox-agent/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.rox-agent/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.rox-agent/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.rox-agent/config-defaults.json` | Always overwrite on launch |
