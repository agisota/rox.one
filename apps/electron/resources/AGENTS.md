...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.rox/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.rox/docs/` | Always overwrite on launch |
| `themes/` | `~/.rox/themes/` | Always overwrite on launch |
| `permissions/` | `~/.rox/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.rox/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.rox/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.rox/config-defaults.json` | Always overwrite on launch |
