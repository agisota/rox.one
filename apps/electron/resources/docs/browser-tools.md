...
Use `browser_tool` to control built-in browser windows (Chromium) inside Rox Agents.
...
- Before first browser tool usage, the agent must read this guide (`~/.rox-agent/docs/browser-tools.md`).
