...
## Bug Fixes
- **WebUI Google OAuth redirect mismatch** — Fixed `redirect_uri_mismatch` in WebUI by using a stable provider-facing callback (`https://agents.rox.do/auth/callback`) and relaying the real target through state.
