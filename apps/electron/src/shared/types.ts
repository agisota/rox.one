...
// Core types are re-exported from @rox-agent/core
...
import type { SessionMetadata as SharedSessionMetadata } from '@rox-agent/shared/sessions/types';

// Import backend capabilities type
import type { AgentCapabilities } from '@rox-agent/shared/agent/backend';
export type { AgentCapabilities };

// Import LLM connection types
import type { LlmConnection, LlmConnectionWithStatus, LlmAuthType, LlmProviderType } from '@rox-agent/shared/config';
...
import type { AuthRequest as SharedAuthRequest, CredentialInputMode as SharedCredentialInputMode, CredentialAuthRequest as SharedCredentialAuthRequest } from '@rox-agent/shared/agent';
...
export type { PermissionRequest as BasePermissionRequest } from '@rox-agent/core/types';
import type { PermissionRequest as BasePermissionRequest } from '@rox-agent/core/types';
...
// CredentialInputMode is imported from @rox-agent/shared/agent above
...
import type { Message } from '@rox-agent/core/types';
...
export type SessionEvent =
  ...
  | { type: 'tool_start'; sessionId: string; toolName: string; toolUseId: string; toolInput: Record<string, unknown>; toolIntent?: string; toolDisplayName?: string; toolDisplayMeta?: import('@rox-agent/core').ToolDisplayMeta; turnId?: string; parentToolUseId?: string; timestamp?: number }
...
export interface SendMessageOptions {
  ...
  badges?: import('@rox-agent/core').ContentBadge[]
 ...
 * Uses SharedSessionMetadata from @rox-agent/shared (not core SessionMetadata)
 */
...
export const IPC_CHANNELS = {
  ...
  // Deep link navigation (main → renderer, for external roxagents:// URLs)
  ...
  // Default permissions from ~/.rox-agent/permissions/default.json
...
import type { Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from '@rox-agent/core/types';
...
export interface ElectronAPI {
  ...
  // Deep link navigation listener (for external roxagents:// URLs)
