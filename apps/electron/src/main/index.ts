...
import { DEFAULT_LOCAL_SCOPE, getWorkspaces, getWorkspaceByNameOrId, loadStoredConfig, addWorkspace, saveConfig } from '@craft-agent/shared/config'
...
if (!gotTheLock) {
  ...
  app.on('second-instance', (_event, commandLine, _workingDirectory) => {
    ...
    const url = commandLine.find(arg => arg.startsWith(`${DEEPLINK_SCHEME}://`) || arg.startsWith('craftagents://'))
