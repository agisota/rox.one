...
import { getAuthState, getValidClaudeOAuthToken } from '@rox-agent/shared/auth'
...
import { generateSessionTitle, regenerateSessionTitle, formatPathsToRelative, formatToolInputPaths, perf, encodeIconToDataUrl, getEmojiIcon, resetSummarizationClient, resolveToolIcon, type TitleGeneratorOptions } from '@rox-agent/shared/utils'
...
import { DEFAULT_MODEL, DEFAULT_CODEX_MODEL, getToolIconsDir, isCodexModel } from '@rox-agent/shared/config'
...
/** Agent type - RoxAgent for Claude, CodexBackend for Codex */
type AgentInstance = RoxAgent | CodexBackend
...
• For ongoing shells, the agent can use BashOutput to check status`
   ...
   */
  getCapabilities(sessionId?: string): ReturnType<RoxAgent['capabilities']> | ReturnType<CodexBackend['capabilities']> | null {
