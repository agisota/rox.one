...
import { registerSessionsHandlers, cleanupSessionFileWatchForClient } from '@rox-agent/server-core/handlers/rpc'
...
describe('sessions file watchers', () => {
  ...
  beforeEach(() => {
    ...
    tempRoot = mkdtempSync(join(tmpdir(), 'rox-session-watchers-'))
