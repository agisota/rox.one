...
mock.module('@rox-agent/shared/agent', () => ({
...
mock.module('@rox-agent/shared/agent/backend', () => ({
...
mock.module('@rox-agent/shared/sources', () => ({
...
mock.module('@rox-agent/shared/automations', () => ({
...
mock.module('@rox-agent/shared/sessions', () => ({
  listSessions: () => [],
