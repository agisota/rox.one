...
export interface AppShellContextType {
  ...
  modelDefaults: import('@rox-agent/shared/config/models').ModelDefaults
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@rox-agent/core').ContentBadge[]) => void
