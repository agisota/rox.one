...
import { parsePermissionMode } from '@rox-agent/shared/agent/mode-types'
...
export { isSessionsNavigation, isSourcesNavigation, isSettingsNavigation, isSkillsNavigation, isAutomationsNavigation, isWorkbenchNavigation }
