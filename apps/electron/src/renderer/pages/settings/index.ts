...
export { default as TeamManagementSettingsPage, meta as TeamManagementMeta } from './TeamManagementSettingsPage'
export { default as TeamPermissionsSettingsPage, meta as TeamPermissionsMeta } from './TeamPermissionsSettingsPage'
...
export { default as AccountSettingsPage, meta as AccountSettingsMeta } from './AccountSettingsPage'
