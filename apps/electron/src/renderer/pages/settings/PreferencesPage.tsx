 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.rox-agent/preferences.json).
 * Features:
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help Rox Agent personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How Rox Agent should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for Rox Agent's responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps Rox Agent understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like Rox Agent to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
