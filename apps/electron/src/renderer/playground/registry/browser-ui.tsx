...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    ...
    {
      id: 'mock-2',
      url: 'https://linear.app/rox-docs/settings/teams',
      title: 'Linear',
      favicon: null,
      isLoading: true,
      canGoBack: true,
    ...
    {
      id: 'mock-3',
      url: 'https://roxdocs.bamboohr.com/employees/pto/?id=132',
      title: 'BambooHR',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    ...
    {
      id: 'long-2',
      url: 'https://linear.app/rox-docs/issue/CHA-999/very-long-title-to-test-truncation-behavior-in-top-bar-badges',
  ...
  'many-running': [
    ...
    {
      id: 'run-2',
      url: 'https://linear.app/rox-docs/team/CHA/active',
    ...
    {
      id: 'run-4',
      url: 'https://roxdocs.bamboohr.com/reports',
  ...
  'stress-mix': [
    ...
    {
      id: 'mix-2',
      url: 'https://linear.app/rox-docs/settings/new-team',
      title: 'Add team',
      favicon: null,
      isLoading: true,
      canGoBack: true,
