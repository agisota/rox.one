...
import { ActionCard } from '@rox-agent/ui'
import {
  flexRender,
  getCoreRowModel,
  getFilteredRowModel,
  ...
  return (
    <ActionCard icon={<FileEdit className={ICON} />} title="Document" tag={format} brandColor={BRAND.notion}
      actions={[
        ...
        { label: 'Save to Rox', variant: 'primary', onClick: noop('Save') },
      ]}>
      <div className="space-y-3">
...
export const actionCardsComponents: ComponentEntry[] = [
  ...
  // 19. Document Draft
  {
    ...
    description: 'Rich document card for Rox/Notion/Blog',
  ...
  // 21. Link Preview
  {
    ...
    props: [
      { name: 'url', description: 'URL', control: { type: 'string', placeholder: 'https://...' }, defaultValue: 'https://rox.do' },
    ],
    variants: [
