...
import { TurnCard, type ActivityItem } from '@rox-agent/ui'
...
import { ChatInputZone } from '@/components/app-shell/input/ChatInputZone'
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/rox-agent',
      },
      {
        name: 'seedRecentDirs',
