...
import type { LlmAuthType, LlmProviderType } from "@rox-agent/shared/config/llm-connections"
...
const SEGMENT_DESCRIPTIONS: Record<ProviderSegment, React.ReactNode> = {
  ...
  pi: <>Use Rox Agents Backend as the main agent.<BetaBadge /><br />Configure with your API key, OAuth subscription, or custom endpoint.</>,
}
...
const API_SETUP_OPTIONS: ApiSetupOption[] = [
  ...
  },
  {
    id: 'pi_chatgpt_oauth',
    name: 'ChatGPT Plus',
    description: 'Use your ChatGPT subscription with Rox Agents Backend.',
  ...
  },
  {
    id: 'pi_copilot_oauth',
    name: 'GitHub Copilot',
    description: 'Use your GitHub Copilot subscription with Rox Agents Backend.',
    icon: <Cpu className="size-4" />,
    providerType: 'pi',
  },
  {
    id: 'pi_api_key',
    name: 'API Key',
    description: 'Use provider presets (Anthropic, OpenAI, Google, etc.) via Rox Agents Backend.',
    icon: <Key className="size-4" />,
    providerType: 'pi',
  },
]
