...
import { Tooltip, TooltipTrigger, TooltipContent, DocumentFormattedMarkdownOverlay } from "@rox-agent/ui"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { buildLabelTree, getDescendantIds, getLabelDisplayName, flattenLabels, extractLabelId, findLabelById } from "@rox-agent/shared/labels"
import type { LabelConfig, LabelTreeNode } from "@rox-agent/shared/labels"
...
function AppShellContent({
  ...
  React.useEffect(() => {
    const handleGlobalPaste = (e: ClipboardEvent) => {
      ...
      window.dispatchEvent(new CustomEvent('rox:paste-files', {
                ...
                <div className="flex items-center gap-1">
                  ...
                  <DropdownMenu>
                    ...
                    <StyledDropdownMenuContent align="end" side="top" sideOffset={8}>
                      ...
                      <StyledDropdownMenuSeparator />
                      <StyledDropdownMenuItem onClick={() => window.electronAPI.openUrl('https://agents.rox.do/docs')}>
