  ...
  React.useEffect(() => {
    const handleApprovePlanWithCompact = (e: CustomEvent<{ sessionId?: string; planPath?: string }>) => {
      ...
      const handleCompactionComplete = (compactEvent: CustomEvent<{ sessionId?: string }>) => {
        ...
        window.removeEventListener('rox:compaction-complete', handleCompactionComplete as EventListener)
      ...
      window.addEventListener('rox:compaction-complete', handleCompactionComplete as EventListener)
    }

    window.addEventListener('rox:approve-plan-with-compact', handleApprovePlanWithCompact as EventListener)
    return () => window.removeEventListener('rox:approve-plan-with-compact', handleApprovePlanWithCompact as EventListener)
  }, [sessionId, permissionMode, onPermissionModeChange, onSubmit])
