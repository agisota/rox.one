import type { PromptRewriteOutput, PromptRewriteRequest } from '@rox-agent/shared/workbench';
import type { ProductMode, ProductModeIntent } from './product-mode-toolbar';

export const PROMPT_REWRITE_SPEC_BUILDER_EVENT = 'rox:spec-builder-intent';
