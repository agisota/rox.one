...
import { TurnCard, UserMessageBubble, groupMessagesByTurn, formatTurnAsMarkdown, formatActivityAsMarkdown, type Turn, type AssistantTurn, type UserTurn, type SystemTurn, type AuthRequestTurn } from "@rox-agent/ui"
...
interface ChatDisplayProps {
  ...
  labels?: import('@rox-agent/shared/labels').LabelConfig[]
...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.rox-agent/preferences.json (not localStorage)
  ...
  // Uses the shared extractOverlayData parser from @rox-agent/ui
                  ...
                  {turns.map((turn, index) => {
                    ...
                    return (
                      ...
                      <TurnCard
                        ...
                        compactMode={compactMode}
                        onAcceptPlan={() => {
                          window.dispatchEvent(new CustomEvent('rox:approve-plan', {
                        ...
                        onAcceptPlanWithCompact={() => {
                          ...
                          window.dispatchEvent(new CustomEvent('rox:approve-plan-with-compact', {
