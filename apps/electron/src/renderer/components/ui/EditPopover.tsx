...
import { usePlatform } from '@rox-one/ui'
  ...
  'add-source-local': (location) => ({
    context: {
      ...
      context:
        ...
        'First, look up the ROX ONE Docs guide: mcp__craft-agents-docs__SearchCraftAgents({ query: "filesystem" }). ' +
  ...
  'edit-tool-icons': (location) => ({
    context: {
      ...
      context:
        ...
        'The file is tool-icons.json in ~/.rox/tool-icons/. Icon image files live in the same directory. ' +
        ...
        'Read ~/.rox/docs/tool-icons.md for full format reference. ' +
