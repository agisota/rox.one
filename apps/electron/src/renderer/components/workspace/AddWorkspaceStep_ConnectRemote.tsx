...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote Rox Agent Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    const defaultBasePath = `${homeDir}/.rox-agent/workspaces`
  ...
  return (
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description="Connect to a remote Rox Agent Server for this workspace."
      />
