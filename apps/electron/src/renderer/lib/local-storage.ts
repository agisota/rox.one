/* eslint-disable rox-agent/no-localstorage -- Compatibility boundary: renderer settings still rely on synchronous reads during initial render. Keep direct localStorage access isolated here until callers are migrated to async preferences APIs. */
/**
