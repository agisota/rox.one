...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-00-*-design.md`
- **Yaml:** `wt-meta/wt-00.yaml`
- **Mission control:** `docs/mission-control/wt-00/`
- **Linear epic:** None
- **Feature flag:** `None` (OFF by default)
