...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-01-*-design.md`
- **Yaml:** `wt-meta/wt-01.yaml`
- **Mission control:** `docs/mission-control/wt-01/`
- **Linear epic:** PZD-119
- **Feature flag:** `rox.feature.release.r2-mirror` (OFF by default)
