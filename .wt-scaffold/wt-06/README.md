...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-06-*-design.md`
- **Yaml:** `wt-meta/wt-06.yaml`
- **Mission control:** `docs/mission-control/wt-06/`
- **Linear epic:** PZD-122
- **Feature flag:** `rox.feature.contracts.workspace-team.v1` (OFF by default)
