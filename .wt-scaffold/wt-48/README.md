...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-48-*-design.md`
- **Yaml:** `wt-meta/wt-48.yaml`
- **Mission control:** `docs/mission-control/wt-48/`
- **Linear epic:** PZD-115
- **Feature flag:** `rox.feature.ai-context-packet-v1` (OFF by default)
