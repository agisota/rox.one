...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-04-*-design.md`
- **Yaml:** `wt-meta/wt-04.yaml`
- **Mission control:** `docs/mission-control/wt-04/`
- **Linear epic:** PZD-113
- **Feature flag:** `rox.feature.contracts.user-v1` (OFF by default)
