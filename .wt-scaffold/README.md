...
Per-worktree scaffold READMEs live under `wt-NN/`. Each WT-NN branch
maintains its own `.wt-scaffold/wt-NN/README.md`.

- [WT-00 Snapshot Hygiene](./wt-00/README.md)
- [WT-02 ROX Design security/lifecycle hardening](./wt-02/README.md)
- [WT-03 ROX Design TopBar UX + hotkey](./wt-03/README.md)
...
- [WT-08 Audit + Telemetry data contract](./wt-08/README.md)
