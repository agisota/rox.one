...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-46-*-design.md`
- **Yaml:** `wt-meta/wt-46.yaml`
- **Mission control:** `docs/mission-control/wt-46/`
- **Linear epic:** PZD-122
- **Feature flag:** `rox.feature.content-object-v1` (OFF by default)
