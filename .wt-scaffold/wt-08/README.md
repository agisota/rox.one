...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-08-*-design.md`
- **Yaml:** `wt-meta/wt-08.yaml`
- **Mission control:** `docs/mission-control/wt-08/`
- **Linear epic:** PZD-118
- **Feature flag:** `rox.feature.audit.baseline` (OFF by default)
