...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-07-*-design.md`
- **Yaml:** `wt-meta/wt-07.yaml`
- **Mission control:** `docs/mission-control/wt-07/`
- **Linear epic:** PZD-115
- **Feature flag:** `rox.feature.entitlements.v1` (OFF by default)
