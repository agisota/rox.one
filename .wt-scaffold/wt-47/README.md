...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-47-*-design.md`
- **Yaml:** `wt-meta/wt-47.yaml`
- **Mission control:** `docs/mission-control/wt-47/`
- **Linear epic:** PZD-122
- **Feature flag:** `rox.feature.relation-service-v1` (OFF by default)
