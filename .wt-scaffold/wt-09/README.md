...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-09-*-design.md`
- **Yaml:** `wt-meta/wt-09.yaml`
- **Mission control:** `docs/mission-control/wt-09/`
- **Linear epic:** None
- **Feature flag:** `rox.process.orchestrator-sync.v1` (OFF by default)
