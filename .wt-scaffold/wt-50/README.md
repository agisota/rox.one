...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-50-*-design.md`
- **Yaml:** `wt-meta/wt-50.yaml`
- **Mission control:** `docs/mission-control/wt-50/`
- **Linear epic:** PZD-122
- **Feature flag:** `rox.feature.search-index-v1` (OFF by default)
