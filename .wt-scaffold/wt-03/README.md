...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-03-*-design.md`
- **Yaml:** `wt-meta/wt-03.yaml`
- **Mission control:** `docs/mission-control/wt-03/`
- **Linear epic:** PZD-116
- **Feature flag:** `rox.feature.rox-design.topbar-button` (OFF by default)
