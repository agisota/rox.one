...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-02-*-design.md`
- **Yaml:** `wt-meta/wt-02.yaml`
- **Mission control:** `docs/mission-control/wt-02/`
- **Linear epic:** PZD-116
- **Feature flag:** `rox.feature.rox-design.hardening-v2` (OFF by default)
