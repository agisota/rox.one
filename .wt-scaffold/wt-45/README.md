...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-45-*-design.md`
- **Yaml:** `wt-meta/wt-45.yaml`
- **Mission control:** `docs/mission-control/wt-45/`
- **Linear epic:** PZD-122
- **Feature flag:** `rox.feature.modules.registry-v1` (OFF by default)
