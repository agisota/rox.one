...
- **Spec:** `docs/superpowers/specs/2026-05-21-wt-05-*-design.md`
- **Yaml:** `wt-meta/wt-05.yaml`
- **Mission control:** `docs/mission-control/wt-05/`
- **Linear epic:** PZD-113
- **Feature flag:** `rox.feature.contracts.tenant-org.v1` (OFF by default)
